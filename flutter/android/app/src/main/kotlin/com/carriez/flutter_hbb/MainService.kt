...
const val DEFAULT_NOTIFY_TITLE = "IT-Breitenstein Fernwartung"
...
class MainService : Service() {
    ...
    private fun initNotification() {
        ...
        notificationChannel = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "ITBreitensteinFernwartung"
            val channelName = "IT-Breitenstein Fernwartung Service"
            val channel = NotificationChannel(
                channelId,
                channelName, NotificationManager.IMPORTANCE_HIGH
            ).apply {
                description = "IT-Breitenstein Fernwartung Service Channel"
            }
