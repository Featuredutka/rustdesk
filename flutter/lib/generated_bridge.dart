...
abstract class ItBreitensteinFernwartung {
  ...
  FlutterRustBridgeTaskConstMeta get kMainHasGpucodecConstMeta;
  ...
  FlutterRustBridgeTaskConstMeta get kMainHasPixelbufferTextureRenderConstMeta;
...
class ItBreitensteinFernwartungImpl implements ItBreitensteinFernwartung {
  final ItBreitensteinFernwartungPlatform _platform;
  factory ItBreitensteinFernwartungImpl(ExternalLibrary dylib) =>
      ItBreitensteinFernwartungImpl.raw(
          ItBreitensteinFernwartungPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory ItBreitensteinFernwartungImpl.wasm(FutureOr<WasmModule> module) =>
      ItBreitensteinFernwartungImpl(module as ExternalLibrary);
  ItBreitensteinFernwartungImpl.raw(this._platform);
  Stream<String> startGlobalEventStream(
      {required String appType, dynamic hint}) {
  ...
  bool mainHasGpucodec({dynamic hint}) {
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner.wire_main_has_gpucodec(),
      parseSuccessData: _wire2api_bool,
      constMeta: kMainHasGpucodecConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  bool mainHasPixelbufferTextureRender({dynamic hint}) {
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner.wire_main_has_pixelbuffer_texture_render(),
      parseSuccessData: _wire2api_bool,
      constMeta: kMainHasPixelbufferTextureRenderConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta
      get kMainHasPixelbufferTextureRenderConstMeta =>
          const FlutterRustBridgeTaskConstMeta(
            debugName: "main_has_pixelbuffer_texture_render",
            argNames: [],
          );
...
class ItBreitensteinFernwartungPlatform
    extends FlutterRustBridgeBase<ItBreitensteinFernwartungWire> {
  ItBreitensteinFernwartungPlatform(ffi.DynamicLibrary dylib)
      : super(ItBreitensteinFernwartungWire(dylib));
...
class ItBreitensteinFernwartungWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  ItBreitensteinFernwartungWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ItBreitensteinFernwartungWire.fromLookup(
  ...
  WireSyncReturn wire_main_has_gpucodec() {
    return _wire_main_has_gpucodec();
  }

  late final _wire_main_has_gpucodecPtr =
      _lookup<ffi.NativeFunction<WireSyncReturn Function()>>(
          'wire_main_has_gpucodec');
  late final _wire_main_has_gpucodec =
      _wire_main_has_gpucodecPtr.asFunction<WireSyncReturn Function()>();
  ...
  WireSyncReturn wire_main_has_pixelbuffer_texture_render() {
    return _wire_main_has_pixelbuffer_texture_render();
  }

  late final _wire_main_has_pixelbuffer_texture_renderPtr =
      _lookup<ffi.NativeFunction<WireSyncReturn Function()>>(
          'wire_main_has_pixelbuffer_texture_render');
  late final _wire_main_has_pixelbuffer_texture_render =
      _wire_main_has_pixelbuffer_texture_renderPtr
          .asFunction<WireSyncReturn Function()>();
