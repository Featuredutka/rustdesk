...
pub(super) fn check_display_changed(
    ...
    //  1. The client version < 1.2.5. The client side has to reconnect.
    //  2. The client version > 1.2.5, The client side can handle the case because sync peer info message will be sent.
