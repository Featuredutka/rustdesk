...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään IT-Breitenstein Fernwartung verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa IT-Breitenstein Fernwartung ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi IT-Breitenstein Fernwartungin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava IT-Breitenstein Fernwartungille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava IT-Breitenstein Fernwartungille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten IT-Breitenstein Fernwartung daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota IT-Breitenstein Fernwartungille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli IT-Breitenstein Fernwartung ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "IT-Breitenstein Fernwartung palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa IT-Breitenstein Fernwartungin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "IT-Breitenstein Fernwartung palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep RustDesk background service", "Pidä IT-Breitenstein Fernwartungin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista IT-Breitenstein Fernwartungin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show RustDesk", "Näytä IT-Breitenstein Fernwartung"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista IT-Breitenstein Fernwartung salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "IT-Breitenstein Fernwartung ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä IT-Breitenstein Fernwartung Server Pro versioon {} jatkaaksesi."),
        ...
        ("About RustDesk", "Tietoa IT-Breitenstein Fernwartungistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-IT-Breitenstein Fernwartung-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena IT-Breitenstein Fernwartung vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, IT-Breitenstein Fernwartung ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, IT-Breitenstein Fernwartung ei enää käytä UDP-porttia 21116, vaan sen sijaan käytetään TCP-porttia 21116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: IT-Breitenstein Fernwartung-palvelimen OSS ei sisällä tätä ominaisuutta."),
