...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie IT-Breitenstein Fernwartung"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu IT-Breitenstein Fernwartung na pozadí"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aktualizujte klienta IT-Breitenstein Fernwartung na verziu {} alebo novšiu na vzdialenej strane!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Štandardne IT-Breitenstein Fernwartung overuje certifikát servera pre protokoly používajúce TLS.\nS touto možnosťou IT-Breitenstein Fernwartung v prípade zlyhania overenia preskočí krok overovania a bude pokračovať."),
        ("Disable UDP", "Vypnúť UDP"),
        ("disable-udp-tip", "Určuje, či sa má používať iba TCP.\nKeď je táto možnosť povolená, IT-Breitenstein Fernwartung už nebude používať UDP 21116, namiesto neho sa použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: IT-Breitenstein Fernwartung server OSS túto funkciu neobsahuje."),
