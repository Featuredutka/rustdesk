...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for IT-Breitenstein Fernwartung-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi IT-Breitenstein Fernwartung tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi IT-Breitenstein Fernwartung tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende IT-Breitenstein Fernwartung."),
        ...
        ("verify_rustdesk_password_tip", "Verifiser IT-Breitenstein Fernwartung-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke IT-Breitenstein Fernwartung og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Vennligst oppgrader IT-Breitenstein Fernwartung Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre IT-Breitenstein Fernwartung i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis IT-Breitenstein Fernwartung-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde IT-Breitenstein Fernwartung-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Vennligst oppgrader IT-Breitenstein Fernwartung-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer IT-Breitenstein Fernwartung serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil IT-Breitenstein Fernwartung falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil IT-Breitenstein Fernwartung ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: IT-Breitenstein Fernwartung server OSS inkluderer ikke denne funksjonen."),
