...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Show RustDesk", "IT-Breitenstein Fernwartung 표시"),
        ("This PC", "이 PC"),
        ("or", "또는"),
        ("Elevate", "권한 상승"),
        ...
        ("powered_by_me", "IT-Breitenstein Fernwartung 제공"),
        ...
        ("allow-only-conn-window-open-tip", "IT-Breitenstein Fernwartung 창이 열려 있을 때만 연결 허용"),
        ...
        ("floating_window_tip", "IT-Breitenstein Fernwartung 백그라운드 서비스를 유지하는 데 도움이 됩니다"),
        ...
        ("About RustDesk", "IT-Breitenstein Fernwartung 정보"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "IT-Breitenstein Fernwartung 클라이언트를 원격 버전 {} 이상으로 업그레이드해 주세요!"),
        ...
        ("allow-insecure-tls-fallback-tip", "기본적으로 IT-Breitenstein Fernwartung는 TLS를 사용하여 프로토콜에 대한 서버 인증서를 검증합니다.\n이 옵션을 활성화하면 IT-Breitenstein Fernwartung는 인증 단계를 건너뛰고 인증 실패 시 진행합니다."),
        ("Disable UDP", "UDP 사용 안 함"),
        ("disable-udp-tip", "TCP만 사용할지 여부를 제어합니다.\n이 옵션을 활성화하면 IT-Breitenstein Fernwartung는 더 이상 UDP 2116을 사용하지 않고 대신 TCP 2116을 사용합니다."),
        ("server-oss-not-support-tip", "참고: IT-Breitenstein Fernwartung 서버 OSS에는 이 기능이 포함되어 있지 않습니다."),
