...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-only-conn-window-open-tip", "Povolit připojení pouze v případě, že je otevřené okno IT-Breitenstein Fernwartung"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu IT-Breitenstein Fernwartung na pozadí"),
        ...
        ("About RustDesk", "O IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgradujte prosím klienta IT-Breitenstein Fernwartung na verzi {} nebo novější na vzdálené straně!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Ve výchozím nastavení IT-Breitenstein Fernwartung ověřuje certifikát serveru u protokolů používajících TLS.\nKdyž je tato možnost povolena, IT-Breitenstein Fernwartung v případě selhání ověření přejde k přeskočení kroku ověření a bude pokračovat."),
        ("Disable UDP", "Zakázat UDP"),
        ("disable-udp-tip", "Určuje, zda se má používat pouze TCP.\nKdyž je tato možnost povolena, IT-Breitenstein Fernwartung již nebude používat UDP 21116, místo toho se použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: IT-Breitenstein Fernwartung server OSS tuto funkci neobsahuje."),
