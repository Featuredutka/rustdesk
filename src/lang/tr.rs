...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki IT-Breitenstein Fernwartung uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("scam_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden IT-Breitenstein Fernwartung'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Lütfen IT-Breitenstein Fernwartung Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, IT-Breitenstein Fernwartung'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("powered_by_me", "IT-Breitenstein Fernwartung tarafından desteklenmektedir"),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca IT-Breitenstein Fernwartung penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "IT-Breitenstein Fernwartung arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About RustDesk", "IT-Breitenstein Fernwartung Hakkında"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Lütfen uzak tarafta IT-Breitenstein Fernwartung istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, IT-Breitenstein Fernwartung sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda IT-Breitenstein Fernwartung doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, IT-Breitenstein Fernwartung artık UDP 21116'yı kullanmayacak, bunun yerine TCP 21116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: IT-Breitenstein Fernwartung sunucu OSS'si bu özelliği içermemektedir."),
