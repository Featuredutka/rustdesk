...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("powered_by_me", "Didukung oleh IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela IT-Breitenstein Fernwartung sedang terbuka."),
        ...
        ("floating_window_tip", "Untuk menjaga layanan/service IT-Breitenstein Fernwartung agar tetap aktif"),
        ...
        ("About RustDesk", "Tentang IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Silahkan perbarui aplikasi IT-Breitenstein Fernwartung ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Secara default, IT-Breitenstein Fernwartung memverifikasi sertifikat server untuk protokol yang menggunakan TLS.\nDengan opsi ini diaktifkan, IT-Breitenstein Fernwartung akan kembali melewati langkah verifikasi dan melanjutkan jika verifikasi gagal."),
        ("Disable UDP", "Nonaktifkan UDP"),
        ("disable-udp-tip", "Mengontrol apakah hanya menggunakan TCP.\nSaat opsi ini diaktifkan, IT-Breitenstein Fernwartung tidak akan menggunakan UDP 21116 lagi, TCP 21116 akan digunakan sebagai gantinya."),
        ("server-oss-not-support-tip", "CATATAN: IT-Breitenstein Fernwartung server OSS tidak menyertakan fitur ini."),
