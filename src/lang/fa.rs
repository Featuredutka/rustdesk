...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-only-conn-window-open-tip", "باز است اتصال برقرار شود IT-Breitenstein Fernwartung زمانی که"),
        ...
        ("floating_window_tip", "کمک می کند IT-Breitenstein Fernwartung این به حفظ سرویس پس زمینه"),
        ...
        ("About RustDesk", "IT-Breitenstein Fernwartung درباره"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "لطفاً IT-Breitenstein Fernwartung را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
        ...
        ("allow-insecure-tls-fallback-tip", "به‌طور پیش‌فرض، IT-Breitenstein Fernwartung گواهی سرور را برای پروتکل‌ها با استفاده از TLS تأیید می‌کند.\nبا فعال بودن این گزینه، IT-Breitenstein Fernwartung دوباره مرحله تأیید را رد می‌کند و در صورت عدم موفقیت تأیید ادامه می‌دهد."),
        ("Disable UDP", "UDP غیر فعال کردن"),
        ("disable-udp-tip", "کنترل می کند که آیا فقط از TCP استفاده شود یا خیر.\nوقتی این گزینه فعال باشد، IT-Breitenstein Fernwartung دیگر از UDP 21116 استفاده نمی کند، به جای آن از TCP 21116 استفاده می شود."),
        ("server-oss-not-support-tip", "توجه: سرور IT-Breitenstein Fernwartung OSS این ویژگی را ندارد."),
