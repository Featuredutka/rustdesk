...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge IT-Breitenstein Fernwartung behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge IT-Breitenstein Fernwartung behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för IT-Breitenstein Fernwartung."),
        ...
        ("verify_rustdesk_password_tip", "Verifiera IT-Breitenstein Fernwartung-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda IT-Breitenstein Fernwartung och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Uppgradera IT-Breitenstein Fernwartung Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra IT-Breitenstein Fernwartung från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om IT-Breitenstein Fernwartung-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla IT-Breitenstein Fernwartung-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Uppgradera IT-Breitenstein Fernwartung-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar IT-Breitenstein Fernwartung serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar IT-Breitenstein Fernwartung över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder IT-Breitenstein Fernwartung inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: IT-Breitenstein Fernwartung server OSS inkluderar inte denna funktion."),
