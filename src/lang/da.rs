...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn IT-Breitenstein Fernwartung appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open-source driveren, og aktivere software rendering. Et genstart af IT-Breitenstein Fernwartung er nødvendigt."),
        ("Always use software rendering", "Brug altid software rendering"),
        ("config_input", "For at styre fjernskrivebordet med tastaturet, skal du give IT-Breitenstein Fernwartung rettigheder til at optage tastetryk"),
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give IT-Breitenstein Fernwartung rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC vinduet ved kørsel af IT-Breitenstein Fernwartung."),
        ...
        ("verify_rustdesk_password_tip", "Bekræft IT-Breitenstein Fernwartung adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge IT-Breitenstein Fernwartung til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Opgradér venligst IT-Breitenstein Fernwartung Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre IT-Breitenstein Fernwartung i at køre normalt."),
        ...
        ("powered_by_me", "Drives af IT-Breitenstein Fernwartung"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af IT-Breitenstein Fernwartung med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis IT-Breitenstein Fernwartung vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper på at IT-Breitenstein Fernwartung baggrundstjenesten kører"),
        ...
        ("About RustDesk", "Om IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Opgrader venligst IT-Breitenstein Fernwartung-klienten til version {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verificerer IT-Breitenstein Fernwartung servercertifikatet for protokoller, der bruger TLS.\nNår denne indstilling er aktiveret, vil IT-Breitenstein Fernwartung springe verificeringstrinnet over og fortsætte, hvis verificeringen mislykkes."),
        ("Disable UDP", "Deaktivér UDP"),
        ("disable-udp-tip", "Bestemmer, om der kun skal bruges TCP.\nNår denne indstilling er aktiveret, vil IT-Breitenstein Fernwartung ikke længere bruge UDP 21116; i stedet bruges TCP 21116."),
        ("server-oss-not-support-tip", "BEMÆRK: IT-Breitenstein Fernwartung server OSS indeholder ikke denne funktion."),
