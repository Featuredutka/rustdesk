...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("scam_text1", "Jei kalbatės telefonu su žmogumi, kurio NEPAŽĮSTATE ir kuriuo NEPASITIKITE, ir jis paprašė jūsų naudoti IT-Breitenstein Fernwartung bei paleisti paslaugą, netęskite ir nedelsdami padėkite ragelį."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prašome atnaujinti IT-Breitenstein Fernwartung Server Pro į versiją {} ar naujesnę!"),
        ...
        ("selinux_tip", "Jūsų įrenginyje įjungtas SELinux, kuris gali trukdyti IT-Breitenstein Fernwartung tinkamai veikti kaip valdomajai pusei."),
        ...
        ("powered_by_me", "Veikia su IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Leisti prisijungti tik tada, kai atidarytas IT-Breitenstein Fernwartung langas"),
        ...
        ("floating_window_tip", "Tai padeda išlaikyti IT-Breitenstein Fernwartung foninę paslaugą"),
        ...
        ("About RustDesk", "Apie IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės IT-Breitenstein Fernwartung klientą į {} ar naujesnę versiją!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pagal numatytuosius nustatymus IT-Breitenstein Fernwartung tikrina serverio sertifikatą protokoluose, naudojančiuose TLS.\nĮgalinus šią parinktį, patikros nesėkmės atveju IT-Breitenstein Fernwartung praleis patikros veiksmą ir tęs darbą."),
        ("Disable UDP", "Išjungti UDP"),
        ("disable-udp-tip", "Nurodo, ar naudoti tik TCP.\nĮgalinus šią parinktį, IT-Breitenstein Fernwartung nebenaudos UDP 21116, vietoj jo bus naudojamas TCP 21116."),
        ("server-oss-not-support-tip", "PASTABA: IT-Breitenstein Fernwartung serverio OSS šios funkcijos neturi."),
