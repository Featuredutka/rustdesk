...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de IT-Breitenstein Fernwartung de fondo"),
        ...
        ("About RustDesk", "Acerca de IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, actualiza el cliente IT-Breitenstein Fernwartung a la versión {} o superior en el lado remoto"),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, IT-Breitenstein Fernwartung verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, IT-Breitenstein Fernwartung volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, IT-Breitenstein Fernwartung no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: El servidor IT-Breitenstein Fernwartung OSS no incluye esta característica."),
