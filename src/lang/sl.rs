...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_input", "IT-Breitenstein Fernwartung potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "IT-Breitenstein Fernwartung potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za IT-Breitenstein Fernwartung"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite IT-Breitenstein Fernwartung, prekinite klic in program zaprite."),
        ("scam_text2", "IT-Breitenstein Fernwartung omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite IT-Breitenstein Fernwartung Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno IT-Breitenstein Fernwartunga odprto"),
        ...
        ("floating_window_tip", "Pomaga pri IT-Breitenstein Fernwartung storitvi v ozadju"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite IT-Breitenstein Fernwartung odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto IT-Breitenstein Fernwartung preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo IT-Breitenstein Fernwartung ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, IT-Breitenstein Fernwartung ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik IT-Breitenstein Fernwartung OSS ne vključuje te funkcije."),
