...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("powered_by_me", "Obsługiwane przez IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno IT-Breitenstein Fernwartung jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę IT-Breitenstein Fernwartung w tle"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient IT-Breitenstein Fernwartung do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie IT-Breitenstein Fernwartung weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, IT-Breitenstein Fernwartung pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, IT-Breitenstein Fernwartung nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS IT-Breitenstein Fernwartung nie obsługuje tej funkcji."),
