...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-only-conn-window-open-tip", "仅当 IT-Breitenstein Fernwartung 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 IT-Breitenstein Fernwartung 后台服务"),
        ...
        ("About RustDesk", "关于 IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 IT-Breitenstein Fernwartung 客户端升级至版本 {} 或更新版本！"),
        ...
        ("allow-insecure-tls-fallback-tip", "默认情况下，对于使用 TLS 的协议，IT-Breitenstein Fernwartung 会验证服务器证书。\n启用此选项后，在验证失败时，IT-Breitenstein Fernwartung 将转为跳过验证步骤并继续连接。"),
        ("Disable UDP", "禁用 UDP"),
        ("disable-udp-tip", "控制是否仅使用 TCP。\n启用此选项后，IT-Breitenstein Fernwartung 将不再使用 UDP 21116，而是使用 TCP 21116。"),
        ("server-oss-not-support-tip", "注意：IT-Breitenstein Fernwartung 开源服务器 (OSS server) 不包含此功能。"),
