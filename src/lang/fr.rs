...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("powered_by_me", "Utilise la technologie IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre IT-Breitenstein Fernwartung est ouverte"),
        ...
        ("About RustDesk", "À propos de IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Veuillez mettre le client IT-Breitenstein Fernwartung distant à jour vers la version {} ou ultérieure !"),
        ...
        ("allow-insecure-tls-fallback-tip", "Par défaut, IT-Breitenstein Fernwartung vérifie le certificat du serveur lors de l’utilisation de protocoles utilisant TLS.\nLorsque cette option est activée, IT-Breitenstein Fernwartung autorise les connexions même en cas d’échec de l’étape de vérification."),
        ("Disable UDP", "Désactiver UDP"),
        ("disable-udp-tip", "Contrôle l’utilisation exclusive du mode TCP.\nLorsque cette option est activée, IT-Breitenstein Fernwartung n’utilise plus le port UDP 21116 et utilise le port TCP 21116 à la place."),
        ("server-oss-not-support-tip", "Note : Cette fonctionnalité n’est pas disponible sous la version open-source du serveur IT-Breitenstein Fernwartung."),
