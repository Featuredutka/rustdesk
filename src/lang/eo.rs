...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aŭ tuŝo, vi devas permesi al IT-Breitenstein Fernwartung uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paĝo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], ŝalti la servon [IT-Breitenstein Fernwartung Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep RustDesk background service", "Tenu IT-Breitenstein Fernwartung fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malŝalti ĉi tiun funkcion, bonvolu iri al la sekva paĝo de agordoj de la aplikaĵo de IT-Breitenstein Fernwartung, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ...
        ("Show RustDesk", "Montri IT-Breitenstein Fernwartung"),
        ...
        ("config_input", "Por kontroli la foran labortablon per klavaro, vi devas doni al IT-Breitenstein Fernwartung permeson \"Eniga Monitorado\"."),
        ("config_microphone", "Por paroli fore, vi devas doni al IT-Breitenstein Fernwartung permeson \"Registri Sonon\"."),
        ...
        ("still_click_uac_tip", "Ankoraŭ postulas ke la fora uzanto alklaku Bone en la UAC-fenestro de la funkcianta IT-Breitenstein Fernwartung."),
        ...
        ("verify_rustdesk_password_tip", "Kontroli IT-Breitenstein Fernwartung-pasvorton"),
        ...
        ("scam_text1", "Se vi telefonas kun iu kiun vi NE konas KAJ FIDAS, kiu petis vin uzi IT-Breitenstein Fernwartung kaj komenci la servon, ne daŭrigu kaj tuj malŝaltu la telefonon."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bonvolu ĝisdatigi IT-Breitenstein Fernwartung Server Pro al versio {} aŭ pli nova!"),
        ...
        ("selinux_tip", "SELinux estas ebligita sur via aparato, kio povas malhelpi IT-Breitenstein Fernwartung funkcii ĝuste kiel kontrolata flanko."),
        ...
        ("powered_by_me", "Funkciigita de IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Permesi konekton nur se la fenestro de IT-Breitenstein Fernwartung estas malfermita"),
        ...
        ("floating_window_tip", "Ĝi helpas teni la fonan servon de IT-Breitenstein Fernwartung"),
        ...
        ("About RustDesk", "Pri IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bonvolu ĝisdatigi la IT-Breitenstein Fernwartung-klienton al versio {} aŭ pli nova ĉe la fora flanko!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Implicite, IT-Breitenstein Fernwartung kontrolas la servilan atestilon por protokoloj uzantaj TLS.\nKun ĉi tiu opcio ebligita, IT-Breitenstein Fernwartung retrokadros al preterlaso de la kontrola paŝo kaj daŭrigos en kazo de kontrola malsukceso."),
        ("Disable UDP", "Malebligi UDP"),
        ("disable-udp-tip", "Regas ĉu uzi nur TCP.\nKiam ĉi tiu opcio estas ebligita, IT-Breitenstein Fernwartung ne plu uzos UDP 21116, TCP 21116 estos uzata anstataŭe."),
        ("server-oss-not-support-tip", "NOTU: IT-Breitenstein Fernwartung-servilo OSS ne inkluzivas ĉi tiun funkcion."),
