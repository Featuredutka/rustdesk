...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-only-conn-window-open-tip", "只在 IT-Breitenstein Fernwartung 視窗開啟時允許連接"),
        ...
        ("floating_window_tip", "有助於保持 IT-Breitenstein Fernwartung 後台服務"),
        ...
        ("About RustDesk", "關於 IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "請將遠端 IT-Breitenstein Fernwartung 客戶端升級到 {} 或更新版本！"),
        ...
        ("allow-insecure-tls-fallback-tip", "預設情況下，對於使用 TLS 的協定，IT-Breitenstein Fernwartung 會驗證伺服器的憑證。\n啟用此選項後，在驗證失敗時，IT-Breitenstein Fernwartung 將轉為跳過驗證步驟並繼續連接。"),
        ("Disable UDP", "停用 UDP"),
        ("disable-udp-tip", "控制是否僅使用 TCP。\n啟用此選項後，IT-Breitenstein Fernwartung 將不再使用 UDP 21116，而是使用 TCP 21116。"),
        ("server-oss-not-support-tip", "注意：IT-Breitenstein Fernwartung 開源伺服器 (OSS server) 不包含此功能。"),
