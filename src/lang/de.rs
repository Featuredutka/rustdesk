...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-only-conn-window-open-tip", "Verbindung nur zulassen, wenn das IT-Breitenstein Fernwartung-Fenster geöffnet ist"),
        ...
        ("floating_window_tip", "Es hilft dabei, IT-Breitenstein Fernwartung im Hintergrund auszuführen."),
        ...
        ("About RustDesk", "Über IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bitte aktualisieren Sie den IT-Breitenstein Fernwartung-Client auf der Remote-Seite auf Version {} oder neuer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standardmäßig überprüft IT-Breitenstein Fernwartung das Serverzertifikat für Protokolle, die TLS verwenden. Wenn diese Option aktiviert ist, überspringt IT-Breitenstein Fernwartung den Überprüfungsschritt und fährt im Falle eines Überprüfungsfehlers fort."),
        ("Disable UDP", "UDP deaktivieren"),
        ("disable-udp-tip", "Legt fest, ob nur TCP verwendet werden soll. Wenn diese Option aktiviert ist, verwendet IT-Breitenstein Fernwartung nicht mehr UDP 21116, sondern stattdessen TCP 21116."),
        ("server-oss-not-support-tip", "HINWEIS: IT-Breitenstein Fernwartung Server OSS enthält diese Funktion nicht."),
