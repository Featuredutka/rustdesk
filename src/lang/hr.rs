...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na IT-Breitenstein Fernwartung mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a IT-Breitenstein Fernwartung ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate IT-Breitenstein Fernwartung na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, IT-Breitenstein Fernwartung-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, IT-Breitenstein Fernwartung-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti IT-Breitenstein Fernwartung-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [IT-Breitenstein Fernwartung Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep RustDesk background service", "Zadrži IT-Breitenstein Fernwartung kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje IT-Breitenstein Fernwartung aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show RustDesk", "Prikaži IT-Breitenstein Fernwartung"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti IT-Breitenstein Fernwartungu dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti IT-Breitenstein Fernwartungu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog IT-Breitenstein Fernwartunga."),
        ...
        ("verify_rustdesk_password_tip", "Provjera lozinke za IT-Breitenstein Fernwartung"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete IT-Breitenstein Fernwartung, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ažurirajte IT-Breitenstein Fernwartung Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti IT-Breitenstein Fernwartung da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor IT-Breitenstein Fernwartunga otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa IT-Breitenstein Fernwartunga"),
        ...
        ("About RustDesk", "O IT-Breitenstein Fernwartungu"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo ažurirajte IT-Breitenstein Fernwartung klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, IT-Breitenstein Fernwartung provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, IT-Breitenstein Fernwartung će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, IT-Breitenstein Fernwartung više neće koristiti UDP 21116, već će umjesto toga koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: IT-Breitenstein Fernwartung poslužitelj OSS ne uključuje ovu značajku."),
