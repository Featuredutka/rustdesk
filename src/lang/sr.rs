...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje IT-Breitenstein Fernwartung aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite IT-Breitenstein Fernwartung-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite IT-Breitenstein Fernwartung-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog IT-Breitenstein Fernwartung-a."),
        ...
        ("verify_rustdesk_password_tip", "Potvrdi IT-Breitenstein Fernwartung lozinku"),
        ...
        ("scam_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite IT-Breitenstein Fernwartung i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Molimo nadogradite IT-Breitenstein Fernwartung Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti IT-Breitenstein Fernwartung da radi pravilno kao kontrolisana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je IT-Breitenstein Fernwartung prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se IT-Breitenstein Fernwartung pozadinski servis održi"),
        ...
        ("About RustDesk", "O IT-Breitenstein Fernwartung-u"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo nadogradite IT-Breitenstein Fernwartung klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Podrazumevano, IT-Breitenstein Fernwartung proverava sertifikat servera za protokole koji koriste TLS.\nSa omogućenom ovom opcijom, IT-Breitenstein Fernwartung će preskočiti korak provere i nastaviti u slučaju neuspele provere."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Kontroliše da li se koristi samo TCP.\nKada je ova opcija omogućena, IT-Breitenstein Fernwartung više neće koristiti UDP 21116, umesto toga će se koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: IT-Breitenstein Fernwartung server OSS ne uključuje ovu funkciju."),
