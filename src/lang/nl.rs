...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("powered_by_me", "Werkt met IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het IT-Breitenstein Fernwartung-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt IT-Breitenstein Fernwartung op de achtergrond actief te houden"),
        ...
        ("About RustDesk", "Over IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgrade de IT-Breitenstein Fernwartung client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert IT-Breitenstein Fernwartung het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat IT-Breitenstein Fernwartung verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt IT-Breitenstein Fernwartung niet langer UDP 21116, maar TCP 21116."),
        ("server-oss-not-support-tip", "Opmerking: Deze functie is niet beschikbaar in de open-sourceversie van de IT-Breitenstein Fernwartung-server."),
