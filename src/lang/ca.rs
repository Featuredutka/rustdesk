...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "Lloc web"),
        ("About", "Quant al IT-Breitenstein Fernwartung"),
        ...
        ("install_tip", "En alguns casos és possible que el IT-Breitenstein Fernwartung no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el IT-Breitenstein Fernwartung al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al IT-Breitenstein Fernwartung els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al IT-Breitenstein Fernwartung els permisos de gravació de pantalla."),
        ...
        ("elevated_foreground_window_tip", "La finestra de connexió actual requereix permisos ampliats per a funcionar i, de forma temporal, no es pot utilitzar ni el teclat ni el ratolí. Demaneu a l'usuari remot que minimitzi la finestra actual, o bé que faci clic al botó Permisos ampliats de la finestra d'administració de la connexió. Per a evitar aquest problema en un futur, instal·leu el IT-Breitenstein Fernwartung al dispositiu remot."),
        ...
        ("Show RustDesk", "Mostra el IT-Breitenstein Fernwartung"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al IT-Breitenstein Fernwartung els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al IT-Breitenstein Fernwartung els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del IT-Breitenstein Fernwartung en execució."),
        ...
        ("verify_rustdesk_password_tip", "Verifica la contrasenya del IT-Breitenstein Fernwartung"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del IT-Breitenstein Fernwartung, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualitzeu el IT-Breitenstein Fernwartung Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el IT-Breitenstein Fernwartung funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del IT-Breitenstein Fernwartung està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del IT-Breitenstein Fernwartung en rerefons"),
        ...
        ("About RustDesk", "Quant al IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Actualitzeu el client IT-Breitenstein Fernwartung a la versió {} o superior a la part remota!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per defecte, el IT-Breitenstein Fernwartung verifica el certificat del servidor per als protocols que utilitzen TLS.\nAmb aquesta opció habilitada, el IT-Breitenstein Fernwartung ometrà el pas de verificació i continuarà en cas que aquesta falli."),
        ("Disable UDP", "Inhabilita l'UDP"),
        ("disable-udp-tip", "Controla si s'utilitza només TCP.\nAmb aquesta opció habilitada, el IT-Breitenstein Fernwartung ja no utilitzarà l'UDP 21116, sinó que utilitzarà el TCP 21116 en el seu lloc."),
        ("server-oss-not-support-tip", "NOTA: El IT-Breitenstein Fernwartung Server OSS no inclou aquesta característica."),
