...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra IT-Breitenstein Fernwartung è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio IT-Breitenstein Fernwartung in background."),
        ...
        ("About RustDesk", "Info su IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aggiorna il client IT-Breitenstein Fernwartung remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, IT-Breitenstein Fernwartung verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, IT-Breitenstein Fernwartung salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, IT-Breitenstein Fernwartung non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server IT-Breitenstein Fernwartung non include questa funzionalità."),
