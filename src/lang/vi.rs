...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới IT-Breitenstein Fernwartung..."),
        ...
        ("install_tip", "Do cơ chế UAC, IT-Breitenstein Fernwartung có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt IT-Breitenstein Fernwartung vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho IT-Breitenstein Fernwartung."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho IT-Breitenstein Fernwartung."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [IT-Breitenstein Fernwartung Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep RustDesk background service", "Giữ dịch vụ IT-Breitenstein Fernwartung chạy nền"),
        ...
        ("Show RustDesk", "Hiện IT-Breitenstein Fernwartung"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu IT-Breitenstein Fernwartung"),
        ...
        ("scam_text2", "Chỉ sử dụng IT-Breitenstein Fernwartung với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ IT-Breitenstein Fernwartung mở"),
        ...
        ("floating_window_tip", "Giữ IT-Breitenstein Fernwartung trên cùng"),
        ...
        ("About RustDesk", "Về IT-Breitenstein Fernwartung"),
