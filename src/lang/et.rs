...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("powered_by_me", "Põhineb IT-Breitenstein Fernwartungil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui IT-Breitenstein Fernwartungi aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada IT-Breitenstein Fernwartungi taustateenust."),
        ...
        ("About RustDesk", "IT-Breitenstein Fernwartungi teave"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage IT-Breitenstein Fernwartungi klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib IT-Breitenstein Fernwartung TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab IT-Breitenstein Fernwartung kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta IT-Breitenstein Fernwartung enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: IT-Breitenstein Fernwartungi serveri OSS ei sisalda seda funktsiooni."),
