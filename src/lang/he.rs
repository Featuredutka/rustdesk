...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("About RustDesk", "אודות IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "אנא שדרג את לקוח IT-Breitenstein Fernwartung לגרסה {} או חדשה יותר בצד המרוחק!"),
        ...
        ("allow-insecure-tls-fallback-tip", "כברירת מחדל, IT-Breitenstein Fernwartung מאמת את אישור השרת עבור פרוטוקולים המשתמשים ב-TLS.\nכאשר אפשרות זו מופעלת, IT-Breitenstein Fernwartung יחזור לדילוג על שלב האימות וימשיך במקרה של כשל באימות."),
        ("Disable UDP", "השבת UDP"),
        ("disable-udp-tip", "קובע אם להשתמש ב-TCP בלבד.\nכאשר אפשרות זו מופעלת, IT-Breitenstein Fernwartung לא ישתמש יותר ב-UDP 21116, ובמקום זאת ייעשה שימוש ב-TCP 21116."),
        ("server-oss-not-support-tip", "הערה: גרסת ה-OSS של שרת IT-Breitenstein Fernwartung אינה כוללת תכונה זו."),
