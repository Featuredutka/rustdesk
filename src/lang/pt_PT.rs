...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação IT-Breitenstein Fernwartung, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show RustDesk", "Mostrar IT-Breitenstein Fernwartung"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao IT-Breitenstein Fernwartung as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao IT-Breitenstein Fernwartung as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do IT-Breitenstein Fernwartung em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do IT-Breitenstein Fernwartung"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o IT-Breitenstein Fernwartung e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o IT-Breitenstein Fernwartung Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o IT-Breitenstein Fernwartung de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do IT-Breitenstein Fernwartung estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do IT-Breitenstein Fernwartung"),
        ...
        ("About RustDesk", "Sobre o IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente IT-Breitenstein Fernwartung para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o IT-Breitenstein Fernwartung verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o IT-Breitenstein Fernwartung recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o IT-Breitenstein Fernwartung deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o IT-Breitenstein Fernwartung server OSS não inclui esta funcionalidade."),
