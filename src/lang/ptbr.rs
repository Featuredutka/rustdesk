...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Devido ao UAC, o IT-Breitenstein Fernwartung não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o IT-Breitenstein Fernwartung no sistema."),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o IT-Breitenstein Fernwartung e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o IT-Breitenstein Fernwartung Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o IT-Breitenstein Fernwartung funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por IT-Breitenstein Fernwartung"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do IT-Breitenstein Fernwartung estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço IT-Breitenstein Fernwartung em segundo plano"),
        ...
        ("About RustDesk", "Sobre IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente IT-Breitenstein Fernwartung para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o IT-Breitenstein Fernwartung verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o IT-Breitenstein Fernwartung ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o IT-Breitenstein Fernwartung não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor IT-Breitenstein Fernwartung OSS não inclui este recurso."),
