...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if IT-Breitenstein Fernwartung window is open"),
        ...
        ("floating_window_tip", "It helps to keep IT-Breitenstein Fernwartung background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the IT-Breitenstein Fernwartung client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, IT-Breitenstein Fernwartung verifies the server certificate for protocols using TLS.\nWith this option enabled, IT-Breitenstein Fernwartung will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, IT-Breitenstein Fernwartung will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: IT-Breitenstein Fernwartung server OSS doesn't include this feature."),
