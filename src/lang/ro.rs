...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți IT-Breitenstein Fernwartung să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [IT-Breitenstein Fernwartung Input]."),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi IT-Breitenstein Fernwartung pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Versiunea serverului IT-Breitenstein Fernwartung Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul IT-Breitenstein Fernwartung pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu IT-Breitenstein Fernwartung"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web IT-Breitenstein Fernwartung Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări IT-Breitenstein Fernwartung. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About RustDesk", "Despre IT-Breitenstein Fernwartung"),
        ...
        ("web_id_input_tip", "Introdu ID-ul IT-Breitenstein Fernwartung al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Versiunea clientului IT-Breitenstein Fernwartung de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește IT-Breitenstein Fernwartung Pro pentru funcționalitate completă."),
