...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("allow-only-conn-window-open-tip", "Atļaut savienojumu tikai tad, ja ir atvērts IT-Breitenstein Fernwartung logs"),
        ...
        ("floating_window_tip", "Tas palīdz uzturēt IT-Breitenstein Fernwartung fona servisu"),
        ...
        ("About RustDesk", "Par IT-Breitenstein Fernwartung"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Lūdzu, jauniniet attālās puses IT-Breitenstein Fernwartung klientu uz versiju {} vai jaunāku!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pēc noklusējuma IT-Breitenstein Fernwartung pārbauda servera sertifikātu protokoliem, izmantojot TLS.\nJa šī opcija ir iespējota, IT-Breitenstein Fernwartung izlaidīs verifikācijas soli un turpinās darbību verifikācijas kļūmes gadījumā."),
        ("Disable UDP", "Atspējot UDP"),
        ("disable-udp-tip", "Nosaka, vai izmantot tikai TCP.\nKad šī opcija ir iespējota, IT-Breitenstein Fernwartung vairs neizmantos UDP 21116, tā vietā tiks izmantots TCP 21116."),
        ("server-oss-not-support-tip", "PIEZĪME. IT-Breitenstein Fernwartung servera OSS neietver šo funkciju."),
